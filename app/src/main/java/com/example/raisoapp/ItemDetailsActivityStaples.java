...
public class ItemDetailsActivityStaples extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName.setText("Staples");
        itemPrice.setText(price);
        itemStock.setText("Tersedia, 100 stock lagi");
        itemImage.setImageResource(R.drawable.image6);
