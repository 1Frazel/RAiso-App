...
public class ItemDetailsActivityPulpen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName.setText("Pulpen Hitam");
        itemPrice.setText(price);
        itemStock.setText("Tersedia, 100 stock lagi");
        itemImage.setImageResource(R.drawable.image3);
