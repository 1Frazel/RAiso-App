...
public class ItemDetailsActivityTepak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemName.setText("Tepak Barbie");
        itemPrice.setText(price);
        itemStock.setText("Tersedia, 100 stock lagi");
        itemImage.setImageResource(R.drawable.image7);
